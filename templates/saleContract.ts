...
<div class="sc-wrapper">
    ...
    <p>
        ...
        for <mark>[seller_name]</mark> (hereinafter referred to as seller) and </span> <mark>[buyer_name]</mark> (hereinafter referred to as buyer) to sign the Overseas
    ...
    <table class="item-table">
        <thead>
            <tr>
                ...
                <th style="width: 35%;">Commodity & Description</th>
                <th style="width: 15%;">Quantity</th>
                <th style="width: 15%;">Unit Price</th>
                <th style="width: 15%;">Total</th>
                <th style="width: 10%;">Notice</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>1 <mark>[item_no]</mark></td>
                <td><mark>[hscode]</mark>, <mark>[description]</mark></td>
                <td><mark>[quantity]</mark></td>
                <td><mark>[unit_price]</mark> / <mark>[unit]</mark> <mark>[currency]</mark></td>
                <td><mark>[currency]</mark><mark>[sub_total_price]</mark></td>
                <td><mark>[notice]</mark></td>
            </tr>
            <tr>
                <td>2</td>
                <td></td>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td><mark>[currency]</mark><mark>[total_price]</mark></td>
                <td></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="payment-table">
        <tr>
            <td rowspan="3" class="payment-header" style="width: 20%;">Letter of Credit (L/C)</td>
            <td class="payment-header" style="width: 20%;">Sight Credit</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>irrevocable documentary credit payable at sight</td>
        </tr>
        <tr>
            <td class="payment-header">Deferred Payment Credit</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>irrevocable documentary credit with deferred payment at [ &nbsp; ] days from B/L(AWB) date</td>
        </tr>
        <tr>
            <td class="payment-header">Acceptance Credit</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>irrevocable documentary credit with acceptance of drafts at [ &nbsp; ] days from B/L(AWB) date</td>
        </tr>
        <tr>
            <td rowspan="2" class="payment-header">Documentary Collection</td>
            <td class="payment-header">D/P</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>documents against payment</td>
        </tr>
        <tr>
            <td class="payment-header">D/A</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>documents against acceptance payable at [ &nbsp; ] days from B/L(AWB) date</td>
        </tr>
        <tr>
            <td class="payment-header" colspan="2">Payment in Advance</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>T/T (Telegraph Transfer) within [ &nbsp; ] days from B/L(AWB) date</td>
        </tr>
        <tr>
            <td class="payment-header" colspan="2">Other</td>
            <td style="width: 5%; text-align: center;"><span class="radio-circle" data-group="payment"></span></td>
            <td>T/T (Telegraph Transfer) at least [ &nbsp; ] days before the agreed date of shipment</td>
        </tr>
    </table>

    <ul class="conditions">
        <li>Insurance : Insurance : Under CIF (or CIP), the Seller shall arrange cargo insurance in accordance
            with<br>CIF (or CIP) of the latest Incoterms of the International Chamber of Commerce.</li>
        <li>Packing : [ ex: Export Standard Packing ]</li>
        <li>Marking : [<span style="display:inline-block; width: 300px;"></span>]</li>
        <li>Documents Required :
            <ul style="list-style-type: none; padding-left: 0; margin-top: 5px; width: 100%;">
                <li style="margin-bottom: 5px; display: block;">[ ex: Full set of Clean on Board Bills of Lading ]
                </li>
                <li style="margin-bottom: 5px; display: block;">[ ex: Signed Commercial Invoices in 3 Originals ]</li>
                <li style="margin-bottom: 5px; display: block;">[ ex: Packing Lists in 3 Originals ]</li>
                <li style="margin-bottom: 5px; display: block;">[ ex: Certificate of Origin in 1 Original plus 1 copy
                    ]</li>
                <li style="margin-bottom: 5px; display: block;">[ ex: Inspection Certificate in 2 Originals ]</li>
            </ul>
        </li>
        <li>Other &nbsp;&nbsp;:</li>
    </ul>

    <p style="margin-top: 60px; margin-bottom: 60px;">These Specific Conditions are subject to the General Terms and
        Conditions set forth below.</p>

    <div class="signature-container">
        <div class="signature-column">
            <div class="signature-header">The Seller</div>
            <div class="signature-row">
                <span class="signature-label">By :</span>
                <span class="signature-content"><mark>[seller_name]</mark></span>
            </div>
            <div class="signature-row">
                <span class="signature-label">Address :</span>
                <span class="signature-content"><mark>[seller_address]</mark>, <mark>[seller_city]</mark>, <mark>[seller_country]</mark></span>
            </div>
            <div class="signature-row">
            <span class="signature-label">Name / Title :</span>
            <span class="signature-content">
                <mark>[seller_human_name]</mark><br>
                <mark>[seller_human_position]</mark>
            </span>
        </div>
        ...
        <div class="signature-column">
    <div class="signature-header">The Buyer</div>

    <div class="signature-row">
        <span class="signature-label">By :</span>
        <span class="signature-content"><mark>[buyer_name]</mark></span>
    </div>

    <div class="signature-row">
        <span class="signature-label">Address :</span>
        <span class="signature-content">
            <mark>[buyer_address]</mark>, <mark>[buyer_city]</mark>, <mark>[buyer_country]</mark>
        </span>
    </div>
    ...
    <div class="signature-row">
        <span class="signature-label">Name / Title :</span>
        <span class="signature-content">
            <mark>[buyer_human_name]</mark><br>
            <mark>[buyer_human_position]</mark>
        </span>
    </div>
    ...
    <div class="general-terms-section">
        <h3>1. [General]</h3>
        ...
        <ol class="term-list">
            <li>'seller' authorizes the sales right for distribution channel in <mark>[coo]</mark> to 'Buyer'</li>
            <li>The sales permission area is designated as <mark>[coo]</mark> (hereinafter referred to as "region"), and
            ...
            <li>The buyer's sales channels are permitted only for this contract are as follows. In case of adding sales
        ...
        <h3>3. [Shipment]</h3>
        <ol class="term-list">
            <li>The date of issuance of the bill of lading will be deemed to be the date of shipment unless the bill of
            ...
            <li>Partial shipment and/or transshipment shall be permitted unless otherwise stated in this Sales Contract.
            </li>
            <li>The Seller shall not be responsible for any delay in shipment due to the Buyer's failure to provide
            ...
            <li>If the parties agreed upon a cancellation date for late shipment in the Specific Conditions, the Buyer
        ...
        <ol class="term-list">
            <li>Packing shall be performed at the Seller's option unless otherwise stated in this Sales Contract. In
        ...
        <h3>5. [Insurance]</h3>
        <ol class="term-list">
            <li>In case of CIF, 110% of the invoice amount shall be insured with insurance cover complying with the
                Institute Cargo Clauses (C) or similar clause.</li>
            <li>In case of CIP, 110% of the invoice amount shall be insured with insurance cover complying with the
                Institute Cargo Clauses (A) or similar clause.</li>
        </ol>

        <h3>6. [Buyer's Obligation]</h3>
        <ol class="term-list">
            <li>'Buyer' shall be responsible for sales account, advertisements, and sales promotions, and make best
                efforts to maximize sales in region.</li>
            <li>'Buyer' must obtain the permission from 'seller' when distributing articles related to permitted
            ...
            <li>'Buyer' has the right to select customers, sub-distributors or partners within the defined region.
            ...
            <li>'Buyer' shall investigate the complaints received by customers or business partners within the region
                and shall discuss the relevant measures with 'seller'</li>
            <li>'Buyer' shall not disclose and use any confidential products or information related to 'seller' to a
        ...
        <ol class="term-list">
            <li>'seller' shall support distributor's marketing activities. Especially, 'seller' shall make its best
                effort to support the documentations for marketing. However, it is limited to approved data.</li>
            <li>'seller' shall make its best effort to support the documentations for distribution and sales such as
                product information, export customs clearance documents, import sales (including certification).</li>
            <li>'seller' shall not infringe the authority of 'Buyer' in direct or indirect based on this contract,
                through its employees, agents or other agencies or either on its own</li>
            <li>In the case of changing specifications such as important raw materials or product design in 'seller',
        ...
        <h3>8. [Inspection]</h3>
        <ol class="term-list">
            <li>The inspection of the Goods shall be done according to the export regulation of the Republic of Korea
                and/or by the manufacturer(s), and such inspection shall be considered as final.</li>
            <li>Should any specific inspector be designated by the Buyer, all additional charges incurred thereby shall
        ...
        <ol class="term-list">
            <li>When ordering, 'Buyer' shall clarify information such as packing method, destination information, and
                order quantity, etc.</li>
            <li>'seller' shall notify to 'Buyer' the available quantity and delivery date within 3 business days from
                the date the order is received.</li>
            <li>If the parties have agreed on payment by a documentary credit, then, unless otherwise agreed, a
            ...
            <li>If the parties have agreed on payment by a documentary collection, then, unless otherwise agreed, the
                collection will be subject to the latest Uniform Rules for Collection (URC) of the International Chamber
                of Commerce.
                <ul class="sub-term-list">
            ...
            <li>If the parties have agreed on payment by an open account, then, unless otherwise agreed, the Buyer shall
            ...
            <li>If the parties have agreed on payment by a payment in advance, then, unless otherwise agreed, the Buyer
            ...
            <li>Payment is negotiable like <b>50% pre-deposit on the date of order (proforma invoice issuance date), and
    ...
    <div class="signature-block">
        ...
        <div style="display: flex; justify-content: space-between;">
            <div style="width: 45%;">
                <p class="signature-line">seller: <mark>[seller_name]</mark></p>
                <p class="signature-line">Address: <mark>[seller_address]</mark>, <mark>[seller_city]</mark>, <mark>[seller_country]</mark></p>
                <p class="signature-line">CEO: <mark>[seller_ceo]</mark> (sign)</p>
            </div>
            <div style="width: 45%;">
                <p class="signature-line">Buyer: <mark>[buyer_name]</mark></p>
                <p class="signature-line">Address: <mark>[buyer_address]</mark>, <mark>[buyer_city]</mark>, <mark>[buyer_country]</mark></p>
                <p class="signature-line">CEO: <mark>[buyer_ceo]</mark> (sign)</p>
            </div>
        </div>
    </div>
    ...
    <h2>Appendix</h2>
    <p>1. Product : <mark>[description]</mark></p>
    <p>2. Supply Price: <mark>[currency]</mark> <mark>[unit_price]</mark>/<mark>[unit]</mark> <mark>[incoterms]</mark> <mark>[incoterms_port]</mark> incoterms2020</p>
    <p>3. Total Order &amp; Quantity: <mark>[quantity]</mark></p>
    <p>4. Lead Time : <mark>[lead_time]</mark></p>
